...
// URLs provide a uniform way to locate resources. Here’s 
// how to parse URLs in Go.
func main() {
  // We’ll parse this example URL, which includes a scheme, 
  // authentication info, host, port, path, query params, and 
  // query fragment.
  ...
  // User contains all authentication info; call Username and 
