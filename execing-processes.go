...
func main() {
  ...
  // Exec also needs a set of environment variables to use. Here we 
  // just provide our current environment.
  env := os.Environ()
  ...
  // /bin/ls -a -l -h process. If there is an error we’ll get a return 
  // value.
