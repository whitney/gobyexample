...
func main() {
  ...
  // XXX IMPORTANT: By default sends and receives block until 
  // both the sender and receiver are ready. This property 
  // allowed us to wait at the end of our program for the "ping" 
