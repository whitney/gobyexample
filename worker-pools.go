...
// instances. These workers will receive work on the jobs 
...
func main() {
  ...
  // Here we send 9 jobs and then close that channel to 
  ...
  // by various workers. The program only takes about 3 
  // seconds despite doing about 9 seconds of total work 
